...
public class Cheers {
	   ...
	   String cheers = args[0];
        ...
        { 
                if( capital.charAt(i) == 'A' || capital.charAt(i) == 'E'|| capital.charAt(i) == 'F' || capital.charAt(i) == 'H' || capital.charAt(i) == 'I' || capital.charAt(i) == 'L' || capital.charAt(i) == 'M'|| capital.charAt(i) == 'N' || capital.charAt(i) == 'O' || capital.charAt(i) == 'R'  ){
